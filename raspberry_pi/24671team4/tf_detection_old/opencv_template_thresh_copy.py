...
#     blur = cv2.GaussianBlur(image,(7,7),0)
    ...
    if my_count < 10:
        template = cv2.imread('Red_Cup.png')
        ...
        #print(confidence)
            ...
            #print(pt,((pt[0] + w/2)-320, -(pt[1]+h/2)+240))
                xcentriod = (pt[0] + w/2)-320
                xcentriod = "1," + str(xcentriod) + "\n"
                ser.write(xcentriod.encode('utf-8'))
                line = ser.readline().decode('utf-8').rstrip()
                print(line)
    else:
        template = cv2.imread('blue_cup.png')
        w,h, d = template.shape
